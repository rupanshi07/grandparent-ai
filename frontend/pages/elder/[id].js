          ...
          <div style={styles.leftCol}>
            ...
            <div style={styles.card}>
              <div style={styles.profileHeader}>
                ...
                <div>
                  <h2 style={styles.elderName}>
                    {elder.name}
                  </h2>

                  <p style={styles.elderPhone}>
                    {elder.phone}
                  </p>
                </div>
              </div>
              ...
              <div style={styles.infoGrid}>
                ...
                <div style={styles.infoRow}>
                  ...
                  <span style={styles.infoValue}>
                    {elder.language
                      ? elder.language.charAt(0).toUpperCase() +
                        elder.language.slice(1)
                      : "Not specified"}
                  </span>
                </div>
            ...
            <div style={styles.card}>
              ...
              <p style={styles.cardSubtitle}>
                Currently calling daily at{" "}
                <strong>{elder.call_time}</strong>
              </p>
              ...
              <div style={styles.scheduleRow}>
                ...
                <button
                  onClick={() => updateCallTime(newTime)}
              ...
              <div style={styles.memoryBox}>
                <p style={styles.memoryText}>
                  {elder.memory_summary ||
                    "No previous calls yet. Memory will be built after the first conversation."}
                </p>
              </div>
            </div>
